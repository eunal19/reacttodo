...
export default class App extends Component {
    ...
    if (activeLocal === null && doneLocal === null) {
      setTimeout(() => {
        fetch("https://jsonplaceholder.typicode.com/todos")
          .then((res) => res.json())
          .then((data) => {
            // No need for all the data, slice only 10 and display in the UI
  ...
  doneClicked = () => {
    ...
    activeTasks =
      JSON.parse(localStorage.getItem("activeTasks")) || activeTasks;
  ...
  render() {
    ...
    const textcontent = textHead && (
      <div className="message">
        <h4>
          "{newTodoValue}" Already exist. Check item # {ind + 1}
        </h4>
      </div>
    );
          ...
          <Route exact path="/">
            <div className="App">
              <div className="header">
                ...
                />
                <Button onClick={this.addNewTodo} color="primary">
                  Add
                </Button>
              </div>
              <div>
